...
public class ItemController {
    ...
    public Response exportToPdf() throws JRException {
    ...
    public Response importExcel(@MultipartForm FileRequestDTO request) {
        try{
            return importService.importFileExcel(request);
        } catch (IOException e){
    ...
    @Path("/import/csv")
    @Consumes(MediaType.MULTIPART_FORM_DATA)
    public Response importCSV(@MultipartForm FileRequestDTO request) throws IOException, CsvValidationException {
        return importService.importFileCSV(request);
    }
